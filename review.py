...
def get_companies_data(query_str):
    ...
    for i in q:
        ...
        map_query = '<iframe width="725" height="550" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=dk&amp;geocode=&amp;q=' + address_query + '&amp;aq=&amp;sll=q&amp;sspn=q&amp;t=m&amp;ie=UTF8&amp;hq=&amp;hnear=' + address_query + '&amp;z=14&amp;ll=q&amp;output=embed"></iframe>'
...
def search_navbar():
    ...
    navbar = '<ul class="nav nav-pills"><li class="active"><a href="#">Staff.rs</a></li>'+menu+'</ul>'
    return navbar
